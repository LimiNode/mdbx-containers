#pragma once
#ifndef MDBX_CONTAINERS_HEADER_SYNC_LOGICAL_LOGICAL_SCHEMA_HPP_INCLUDED
#define MDBX_CONTAINERS_HEADER_SYNC_LOGICAL_LOGICAL_SCHEMA_HPP_INCLUDED

/// \file logical/LogicalSchema.hpp
...
namespace sync {
    ...
    enum class LogicalTableKind : std::uint16_t {
        ...
        VectorStore          = 7, ///< Four-DBI vector record collection.
    };
    ...
    inline bool is_known_logical_table_kind(LogicalTableKind kind) {
        switch (kind) {
            ...
            case LogicalTableKind::VectorStore:
                return true;
...
#endif // MDBX_CONTAINERS_HEADER_SYNC_LOGICAL_LOGICAL_SCHEMA_HPP_INCLUDED
