...
| Вопрос | Документ |
| --- | --- |
| Какие таблицы поддержаны и с какой семантикой? | [Матрица покрытия таблиц sync](sync-table-coverage-RU.md) |
| Готова ли функция для v0.1 и что отложено? | [Чек-лист готовности sync v0.1](sync-v0.1-readiness-RU.md) |
| Как будут независимо реплицироваться выбранные raw DBI? | [Проектирование выборочной репликации](sync-selective-replication-design-RU.md) |
| Как безопасно эксплуатировать промышленный транспорт? | [Заметки о промышленном транспорте](sync-transport-production-RU.md) |
